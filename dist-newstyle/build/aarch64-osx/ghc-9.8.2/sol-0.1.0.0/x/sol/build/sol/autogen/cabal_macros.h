...
/* package sol-0.1.0.0 */
#ifndef VERSION_sol
#define VERSION_sol "0.1.0.0"
#endif /* VERSION_sol */
#ifndef MIN_VERSION_sol
#define MIN_VERSION_sol(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_sol */
...
/* tool pkg-config-3.0.3 */
#ifndef TOOL_VERSION_pkg_config
#define TOOL_VERSION_pkg_config "3.0.3"
...
#define CURRENT_COMPONENT_ID "sol-0.1.0.0-inplace-sol"
